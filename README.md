...
1. Import highlights from your Kindle (`My Clippings.txt`) or Kobo (`.kobo/KoboReader.sqlite`)
...
The `relego` CLI can be used instead of the web interface. See the [CLI documentation](https://relego.app/docs/reference/cli) for installation instructions and full command reference.
