...
export function AppShell() {
  ...
  // Sending has no destination until a reader address exists. The palette is the primary
  // action surface on mobile, so it routes to the fix instead of surfacing a server error.
