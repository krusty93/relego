...
to the same screen. The documentation surface makes that literal — three numbered
...
The system's one signature composition. An ordered list of three stations on a `1px`
...
Its companion, the **stop marker**, appears above the `h1` on each of the three stage
